         ...
         < class="card-body">
            <form method="post" action="index.php">
               <div class="row row-cols-lg-auto g-3 align-items-center">
                  ...
                  <input type="text" id="chave" name="chave" placeholder="Informe a chave" value="<?= $chave_pix; ?>" size="50" maxlength="100" onclick="this.select();" data-toggle="tooltip" data-placement="right" title="Informe a chave pix de destino" required>
                  <div id="chaveHelp" class="form-text"></div>
               </div>
               <div class="row row-cols-lg-auto g-3 align-items-center">
               ...
               <p><button type="submit" class="btn btn-primary">Gerar QR Code <i class="fas fa-qrcode"></i></button></i></a></p>
            </form>
</body>
